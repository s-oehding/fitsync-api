...
exports.config = {
   ...
   */
  app_name: [
    `${process.env.NEW_RELIC_APP_NAME} ${process.env.ENVIRONMENT_SCOPE}`,
  ],
  /**
  ...
  logging: {
     ...
     * @env NEW_RELIC_LOG
     */
    filepath: '/var/logs/combined.log',
    //filepath: 'stdout',
    /**
  ...
  error_collector: {
     ...
     */
    ignore_status_codes: [404, 401, 400, 403],
    /**
   ...
   */
  labels: {
    environment: process.env.ENVIRONMENT_SCOPE
  },
